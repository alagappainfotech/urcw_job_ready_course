...
Testing count_words_in_file:
print(count_words_in_file("test_file1.txt"))
None
print()

print("Testing find_longest_line:")
Testing find_longest_line:
print(find_longest_line("test_file1.txt"))
None
print()

print("Testing write_log_entry:")
Testing write_log_entry:
print(write_log_entry("Test log message", "INFO"))
None
print()
print("Testing merge_files:")
Testing merge_files:
print(merge_files("test_file1.txt", "test_file2.txt", "merged.txt"))
None
print()
print("Testing create_csv_from_dict:")
Testing create_csv_from_dict:
test_data = [
        {'name': 'John', 'age': 30, 'city': 'NYC'},
        {'name': 'Jane', 'age': 25, 'city': 'LA'},
        {'name': 'Bob', 'age': 35, 'city': 'Chicago'}
    ]
print(create_csv_from_dict(test_data, "test_people.csv"))
None
print()

print("Testing read_csv_to_dict:")
Testing read_csv_to_dict:
print(read_csv_to_dict("test_people.csv"))
None
print()

print("Testing backup_file:")
Testing backup_file:
print(backup_file("test_file1.txt"))
None
print()
...
(find_files_by_extension(".", "txt"))
print(find_files_by_extension(".", "txt"))
None
print()
print("Testing create_config_file:")
Testing create_config_file:
test_config = {
        'database': {'host': 'localhost', 'port': 5432},
        'app': {'debug': True, 'secret_key': 'abc123'}
}

print(create_config_file(test_config, "test_config.ini"))
None
print()
print("Testing read_config_file:")
Testing read_config_file:
print(read_config_file("test_config.ini"))
None
print()

print("Testing process_log_file:")
Testing process_log_file:
...
55
49
print(process_log_file("test_app.log"))
None
print()

print("Testing create_json_backup:")
Testing create_json_backup:
test_data = {'users': [{'name': 'John'}, {'name': 'Jane'}]}
print(create_json_backup(test_data, "test_users.json"))
None
print()

print("Testing validate_file_exists:")
Testing validate_file_exists:
print(validate_file_exists("test_file1.txt"))
None
print(validate_file_exists("nonexistent.txt"))
None
print()
test_files = [
